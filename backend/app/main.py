...
# Include API routers
from app.api.v1 import analyses, physical_nexus, clients, engagements, exemptions, reports, organizations, compliance
...
# VDA router disabled for now - will be added later
# app.include_router(
#     vda.router,
#     prefix=f"{settings.API_V1_PREFIX}/analyses",
#     tags=["vda"]
